...
const AnimationConfig_1 = require("../model/AnimationConfig");
const AnimationState_1 = require("./AnimationState");
class Animation extends BaseObject_1.BaseObject {
    constructor() {
        super(...arguments);
    ...
    playConfig(animationConfig) {
        ...
        //
        const animationState = BaseObject_1.BaseObject.borrowObject(AnimationState_1.AnimationState);
    ...
    getBlendState(type, name, target) {
        ...
        if (!(name in blendStates)) {
            const blendState = blendStates[name] = BaseObject_1.BaseObject.borrowObject(AnimationState_1.BlendState);
