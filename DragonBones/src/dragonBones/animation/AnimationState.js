...
exports.BlendState = exports.AnimationState = void 0;
const BaseObject_1 = require("../core/BaseObject");
const EventObject_1 = require("../event/EventObject");
const TimelineState_1 = require("./TimelineState");
class AnimationState extends BaseObject_1.BaseObject {
    constructor() {
        super(...arguments);
        this._boneMask = [];
        this._boneTimelines = [];
                    ...
                    for (const timelineData of timelineDatas) {
                        switch (timelineData.type) {
                            case 30 /* IKConstraint */: {
                                const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.IKConstraintTimelineState);
                ...
                if (timelineName in boneTimelines) { // Remove bone timeline from map.
                    ...
                    if (timelineDatas !== null) {
                        for (const timelineData of timelineDatas) {
                            switch (timelineData.type) {
                                case 10 /* BoneAll */: {
                                    const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.BoneAllTimelineState);
                                ...
                                case 11 /* BoneTranslate */: {
                                    const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.BoneTranslateTimelineState);
                                    timeline.target = blendState;
                                    timeline.init(this._armature, this, timelineData);
                                    this._boneTimelines.push(timeline);
                                    break;
                                ...
                                case 12 /* BoneRotate */: {
                                    const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.BoneRotateTimelineState);
                                    timeline.target = blendState;
                                    timeline.init(this._armature, this, timelineData);
                                    this._boneTimelines.push(timeline);
                                    break;
                                ...
                                case 13 /* BoneScale */: {
                                    const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.BoneScaleTimelineState);
                                    timeline.target = blendState;
                                    timeline.init(this._armature, this, timelineData);
                                    this._boneTimelines.push(timeline);
                                    break;
                                ...
                                case 60 /* BoneAlpha */: {
                                    const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.AlphaTimelineState);
                                ...
                                case 50 /* Surface */: {
                                    const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.SurfaceTimelineState);
                ...
                if (timelineName in slotTimelines) { // Remove slot timeline from map.
                    ...
                    if (timelineDatas !== null) {
                        for (const timelineData of timelineDatas) {
                            switch (timelineData.type) {
                                case 20 /* SlotDisplay */: {
                                    const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.SlotDisplayTimelineState);
                                ...
                                case 23 /* SlotZIndex */: {
                                    const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.SlotZIndexTimelineState);
                                ...
                                case 21 /* SlotColor */: {
                                    const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.SlotColorTimelineState);
                                    timeline.target = slot;
                                    timeline.init(this._armature, this, timelineData);
                                    this._slotTimelines.push(timeline);
                                    colorFlag = true;
                                ...
                                case 22 /* SlotDeform */: {
                                    ...
                                    for (let i = 0, l = slot.displayFrameCount; i < l; ++i) {
                                        ...
                                        if (geometryData.offset === geometryOffset) {
                                            const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.DeformTimelineState);
    ...
    _advanceFadeTime(passedTime) {
        ...
        if (this._subFadeState < 0) { // Fade start event.
            ...
            if (eventActive) {
                const eventType = isFadeOut ? EventObject_1.EventObject.FADE_OUT : EventObject_1.EventObject.FADE_IN;
        ...
        if (this._subFadeState > 0) { // Fade complete event.
            ...
            const eventActive = this._parent === null && this.actionEnabled;
            if (eventActive) {
                const eventType = isFadeOut ? EventObject_1.EventObject.FADE_OUT_COMPLETE : EventObject_1.EventObject.FADE_IN_COMPLETE;
                if (this._armature.eventDispatcher.hasDBEventListener(eventType)) {
                    const eventObject = BaseObject_1.BaseObject.borrowObject(EventObject_1.EventObject);
                    eventObject.type = eventType;
                    eventObject.armature = this._armature;
    ...
    init(armature, animationData, animationConfig) {
        ...
        this._actionTimeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.ActionTimelineState);
            ...
            for (const timelineData of timelineDatas) {
                switch (timelineData.type) {
                    case 40 /* AnimationProgress */: {
                        const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.AnimationProgressTimelineState);
                    ...
                    case 41 /* AnimationWeight */: {
                        const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.AnimationWeightTimelineState);
                        timeline.target = animationState;
                        timeline.init(this._armature, this, timelineData);
                        this._animationTimelines.push(timeline);
                        break;
                    ...
                    case 42 /* AnimationParameter */: {
                        const timeline = BaseObject_1.BaseObject.borrowObject(TimelineState_1.AnimationParametersTimelineState);
                        timeline.target = animationState;
                        timeline.init(this._armature, this, timelineData);
                        this._animationTimelines.push(timeline);
                        break;
 ...
 * @internal
 */
class BlendState extends BaseObject_1.BaseObject {
    static toString() {
