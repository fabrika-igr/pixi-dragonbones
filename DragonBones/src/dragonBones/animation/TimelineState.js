...
exports.AnimationParametersTimelineState = exports.AnimationWeightTimelineState = exports.AnimationProgressTimelineState = exports.IKConstraintTimelineState = exports.DeformTimelineState = exports.SlotZIndexTimelineState = exports.SlotColorTimelineState = exports.SlotDisplayTimelineState = exports.AlphaTimelineState = exports.SurfaceTimelineState = exports.BoneScaleTimelineState = exports.BoneRotateTimelineState = exports.BoneTranslateTimelineState = exports.BoneAllTimelineState = exports.ZOrderTimelineState = exports.ActionTimelineState = void 0;
...
const BaseTimelineState_1 = require("./BaseTimelineState");
class ActionTimelineState extends BaseTimelineState_1.TimelineState {
    static toString() {
        ...
        if (this._animationState.actionEnabled) {
            ...
            for (let i = 0; i < actionCount; ++i) {
                ...
                if (action.type === 0 /* Play */) {
                    const eventObject = BaseObject_1.BaseObject.borrowObject(EventObject_1.EventObject);
                    ...
                    EventObject_1.EventObject.actionDataToInstance(action, eventObject, this._armature);
                    this._armature._bufferAction(eventObject, true);
                }
                else {
                    const eventType = action.type === 10 /* Frame */ ? EventObject_1.EventObject.FRAME_EVENT : EventObject_1.EventObject.SOUND_EVENT;
        ...
        if (this._setCurrentTime(passedTime)) {
            ...
            if (prevState < 0) {
                if (this.playState !== prevState) {
                    ...
                    if (eventActive && eventDispatcher.hasDBEventListener(EventObject_1.EventObject.START)) {
                        const eventObject = BaseObject_1.BaseObject.borrowObject(EventObject_1.EventObject);
                        eventObject.type = EventObject_1.EventObject.START;
            ...
            if (eventActive && this.currentPlayTimes !== prevPlayTimes) {
                if (eventDispatcher.hasDBEventListener(EventObject_1.EventObject.LOOP_COMPLETE)) {
                    loopCompleteEvent = BaseObject_1.BaseObject.borrowObject(EventObject_1.EventObject);
                    loopCompleteEvent.type = EventObject_1.EventObject.LOOP_COMPLETE;
                    loopCompleteEvent.armature = this._armature;
                    loopCompleteEvent.animationState = this._animationState;
                }
                if (this.playState > 0) {
                    if (eventDispatcher.hasDBEventListener(EventObject_1.EventObject.COMPLETE)) {
                        completeEvent = BaseObject_1.BaseObject.borrowObject(EventObject_1.EventObject);
                        completeEvent.type = EventObject_1.EventObject.COMPLETE;
 ...
 * @internal
 */
class ZOrderTimelineState extends BaseTimelineState_1.TimelineState {
    static toString() {
 ...
 * @internal
 */
class BoneAllTimelineState extends BaseTimelineState_1.MutilpleValueTimelineState {
    static toString() {
    ...
    _onArriveAtFrame() {
        ...
        if (this._isTween && this._frameIndex === this._frameCount - 1) {
            this._rd[2] = Transform_1.Transform.normalizeRadian(this._rd[2]);
            this._rd[3] = Transform_1.Transform.normalizeRadian(this._rd[3]);
        }
 ...
 * @internal
 */
class BoneTranslateTimelineState extends BaseTimelineState_1.DoubleValueTimelineState {
    static toString() {
 ...
 * @internal
 */
class BoneRotateTimelineState extends BaseTimelineState_1.DoubleValueTimelineState {
    static toString() {
    ...
    _onArriveAtFrame() {
        super._onArriveAtFrame();
        if (this._isTween && this._frameIndex === this._frameCount - 1) {
            this._differenceA = Transform_1.Transform.normalizeRadian(this._differenceA);
            this._differenceB = Transform_1.Transform.normalizeRadian(this._differenceB);
        }
    }
    init(armature, animationState, timelineData) {
        super.init(armature, animationState, timelineData);
    ...
    fadeOut() {
        this.dirty = false;
        this._resultA = Transform_1.Transform.normalizeRadian(this._resultA);
        this._resultB = Transform_1.Transform.normalizeRadian(this._resultB);
    }
    blend(isDirty) {
        const blendState = this.target;
        const bone = blendState.target;
 ...
 * @internal
 */
class BoneScaleTimelineState extends BaseTimelineState_1.DoubleValueTimelineState {
    static toString() {
 ...
 * @internal
 */
class SurfaceTimelineState extends BaseTimelineState_1.MutilpleValueTimelineState {
    static toString() {
 ...
 * @internal
 */
class AlphaTimelineState extends BaseTimelineState_1.SingleValueTimelineState {
    static toString() {
...
exports.AlphaTimelineState = AlphaTimelineState;
/**
 * @internal
 */
class SlotDisplayTimelineState extends BaseTimelineState_1.TimelineState {
    static toString() {
...
exports.SlotDisplayTimelineState = SlotDisplayTimelineState;
/**
 * @internal
 */
class SlotColorTimelineState extends BaseTimelineState_1.TweenTimelineState {
    constructor() {
        super(...arguments);
 ...
 * @internal
 */
class SlotZIndexTimelineState extends BaseTimelineState_1.SingleValueTimelineState {
    static toString() {
...
exports.SlotZIndexTimelineState = SlotZIndexTimelineState;
/**
 * @internal
 */
class DeformTimelineState extends BaseTimelineState_1.MutilpleValueTimelineState {
    static toString() {
 ...
 * @internal
 */
class IKConstraintTimelineState extends BaseTimelineState_1.DoubleValueTimelineState {
    static toString() {
 ...
 * @internal
 */
class AnimationProgressTimelineState extends BaseTimelineState_1.SingleValueTimelineState {
    static toString() {
...
exports.AnimationProgressTimelineState = AnimationProgressTimelineState;
/**
 * @internal
 */
class AnimationWeightTimelineState extends BaseTimelineState_1.SingleValueTimelineState {
    static toString() {
...
exports.AnimationWeightTimelineState = AnimationWeightTimelineState;
/**
 * @internal
 */
class AnimationParametersTimelineState extends BaseTimelineState_1.DoubleValueTimelineState {
    static toString() {
...
exports.AnimationParametersTimelineState = AnimationParametersTimelineState;
