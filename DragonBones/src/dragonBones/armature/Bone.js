...
class Bone extends TransformObject_1.TransformObject {
    constructor() {
        super(...arguments);
        /**
         * @internal
         */
        this.animationPose = new Transform_1.Transform();
    }
    static toString() {
    ...
    _updateGlobalTransformMatrix(isCache) {
        ...
        const flipY = this._armature.flipY === DragonBones_1.DragonBones.yDown;
