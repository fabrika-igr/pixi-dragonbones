...
exports.Slot = exports.DisplayFrame = void 0;
const BaseObject_1 = require("../core/BaseObject");
const DragonBones_1 = require("../core/DragonBones");
...
const Armature_1 = require("./Armature");
const TransformObject_1 = require("./TransformObject");
/**
 * @private
 */
class DisplayFrame extends BaseObject_1.BaseObject {
    constructor() {
        super(...arguments);
        this.deformVertices = [];
    }
...
exports.DisplayFrame = DisplayFrame;
/**
 ...
 * @language zh_CN
 */
class Slot extends TransformObject_1.TransformObject {
    constructor() {
        super(...arguments);
        this._localMatrix = new Matrix_1.Matrix();
        /**
         * @internal
         */
    ...
    _updateDisplayData() {
        ...
        if (this._displayFrame !== prevDisplayFrame ||
            ...
            if (this._geometryData === null && this._textureData !== null) {
                ...
                if (!DragonBones_1.DragonBones.yDown) {
    ...
    _updateDisplay() {
        ...
        if (this._displayFrame !== null) {
            ...
            if (this._display !== null && this._display instanceof Armature_1.Armature) {
    ...
    replaceDisplay(value, index = -1) {
        ...
        if (displayFrame.display !== value) {
            ...
            if (prevDisplay !== null &&
                ...
                if (prevDisplay instanceof Armature_1.Armature) {
            ...
            if (value !== null &&
                ...
                !this._hasDisplay(prevDisplay) &&
                !(value instanceof Armature_1.Armature)) {
    ...
    set displayFrameCount(value) {
        ...
        if (prevCount < value) {
            ...
            for (let i = prevCount; i < value; ++i) {
                this._displayFrames[i] = BaseObject_1.BaseObject.borrowObject(DisplayFrame);
            }
        }
