...
exports.AnimationTimelineData = exports.TimelineData = exports.AnimationData = void 0;
const BaseObject_1 = require("../core/BaseObject");
class AnimationData extends BaseObject_1.BaseObject {
    constructor() {
        super(...arguments);
        /**
         * @private
 ...
 * @private
 */
class TimelineData extends BaseObject_1.BaseObject {
    static toString() {
...
exports.AnimationTimelineData = AnimationTimelineData;
