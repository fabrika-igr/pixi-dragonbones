...
exports.SlotData = exports.SurfaceData = exports.BoneData = exports.ArmatureData = void 0;
...
class ArmatureData extends BaseObject_1.BaseObject {
    constructor() {
        super(...arguments);
        /**
         * @private
         */
        this.aabb = new Rectangle_1.Rectangle();
        /**
 ...
 * @language zh_CN
 */
class BoneData extends BaseObject_1.BaseObject {
    constructor() {
        super(...arguments);
        /**
         * @private
...
class SurfaceData extends BoneData {
    constructor() {
        super(...arguments);
        this.geometry = new DisplayData_1.GeometryData();
    }
    static toString() {
 ...
 * @language zh_CN
 */
class SlotData extends BaseObject_1.BaseObject {
    constructor() {
        super(...arguments);
        /**
         * @private
