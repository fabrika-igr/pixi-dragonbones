...
exports.PolygonBoundingBoxData = exports.EllipseBoundingBoxData = exports.RectangleBoundingBoxData = exports.BoundingBoxData = void 0;
const BaseObject_1 = require("../core/BaseObject");
class BoundingBoxData extends BaseObject_1.BaseObject {
    _onClear() {
        this.color = 0x000000;
        this.width = 0.0;
        this.height = 0.0;
