...
export class ObjectDataParser extends DataParser {
    ...
    private readonly _weightSlotPose: Record<string, Array<number>> = {};
    private readonly _weightBonePoses: Record<string, Array<number>> = {};
    private readonly _cacheBones: Record<string, Array<BoneData>> = {};
    private readonly _slotChildActions: Record<string, Array<ActionData>> = {};
