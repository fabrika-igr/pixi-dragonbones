...
exports.PixiFactory = void 0;
const PIXI = require("pixi.js");
const Armature_1 = require("../../../../../DragonBones/src/dragonBones/armature/Armature");
const BaseObject_1 = require("../../../../../DragonBones/src/dragonBones/core/BaseObject");
const DragonBones_1 = require("../../../../../DragonBones/src/dragonBones/core/DragonBones");
const BaseFactory_1 = require("../../../../../DragonBones/src/dragonBones/factory/BaseFactory");
const PixiArmatureDisplay_1 = require("./PixiArmatureDisplay");
const PixiSlot_1 = require("./PixiSlot");
const PixiTextureAtlasData_1 = require("./PixiTextureAtlasData");
class PixiFactory extends BaseFactory_1.BaseFactory {
    /**
     * @inheritDoc
     */
    constructor(dataParser = null, useSharedTicker = true) {
        ...
        if (PixiFactory._dragonBonesInstance === null) {
            const eventManager = new PixiArmatureDisplay_1.PixiArmatureDisplay(PIXI.Texture.EMPTY);
            PixiFactory._dragonBonesInstance = new DragonBones_1.DragonBones(eventManager);
            if (useSharedTicker) {
    ...
    _buildTextureAtlasData(textureAtlasData, textureAtlas) {
        if (textureAtlasData) {
            ...
            textureAtlasData = BaseObject_1.BaseObject.borrowObject(PixiTextureAtlasData_1.PixiTextureAtlasData);
        }
        return textureAtlasData;
    }
    _buildArmature(dataPackage) {
        const armature = BaseObject_1.BaseObject.borrowObject(Armature_1.Armature);
        const armatureDisplay = new PixiArmatureDisplay_1.PixiArmatureDisplay(PIXI.Texture.EMPTY);
    ...
    _buildSlot(_dataPackage, slotData, armature) {
        const slot = BaseObject_1.BaseObject.borrowObject(PixiSlot_1.PixiSlot);
...
exports.PixiFactory = PixiFactory;
