...
exports.PixiSlot = void 0;
const PIXI = require("pixi.js");
const Slot_1 = require("../../../../../DragonBones/src/dragonBones/armature/Slot");
...
class PixiSlot extends Slot_1.Slot {
    static toString() {
        ...
        if (this._displayIndex >= 0 && this._display !== null && currentTextureData !== null) {
            ...
            if (this._armature.replacedTexture !== null) { // Update replaced texture atlas.
                if (this._armature._replaceTextureAtlasData === null) {
                    currentTextureAtlasData = BaseObject_1.BaseObject.borrowObject(PixiTextureAtlasData_1.PixiTextureAtlasData);
