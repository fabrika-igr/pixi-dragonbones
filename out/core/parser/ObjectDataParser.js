...
export class ObjectDataParser extends DataParser {
    ...
    _parseTimeline(rawData, rawFrames, framesKey, timelineType, frameValueType, frameValueCount, frameParser, timeline = null) {
        ...
        if (rawData !== null) {
            this._timelineArray[timelineOffset + 0 /* BinaryOffset.TimelineScale */] = Math.round(ObjectDataParser._getNumber(rawData, DataParser.SCALE, 1.0) * 100);
            this._timelineArray[timelineOffset + 1 /* BinaryOffset.TimelineOffset */] = Math.round(ObjectDataParser._getNumber(rawData, DataParser.OFFSET, 0.0) * 100);
        }
        else {
